...
def parse_arguments():
    ...
    # Sample the same class
    parser.add_argument('--is_sample', type=bool, default=False, help='sample the same class')
    parser.add_argument('--sample_class', type=int, default=0, help='label chosen for sampling')
